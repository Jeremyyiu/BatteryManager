...
import com.example.jeremy.controller.geo.GeofenceErrorMessages;
            ...
            case ADD:
                ...
                if (mGeofenceListsToAdd.size() > 0) {
                    ...
                    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        new NotificationManager(this).showNotification(getResources().getString(R.string.app_name), "Error Permission refused");
                        return;
                    }
