...
public class AddEditGeofenceActivity extends BaseActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((LocativeApplication) getActivity()).getComponent().inject(this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mIsEditingGeofence) {
            ...
            cursor = resolver.query(Uri.parse("content://" + "JnABatteryManager" + "/geofences"), null, "custom_id = ?", new String[]{String.valueOf(mEditGeofenceId)}, null);
    ...
    public void save(boolean finish) {
        ...
        if (mIsEditingGeofence) {
            Cursor existingCursor = resolver.query(Uri.parse("content://" + "JnABatteryManager" + "/geofences"), null, "custom_id = ?", new String[]{String.valueOf(mEditGeofenceId)}, null);
        ...
        if (mIsEditingGeofence) {
            resolver.update(Uri.parse("content://" + "JnABatteryManager" + "/geofences"), values, "custom_id = ?", new String[]{String.valueOf(mEditGeofenceId)});
        } else {
            resolver.insert(Uri.parse("content://" + "JnABatteryManager" + "/geofences"), values);
        }
