...
import mapareas.MapAreaWrapper.MarkerMoveResult;
...
public class MapAreaManager implements OnMarkerDragListener {
	...
	/**
	 * Set max radius in meters. The circles will expand above this, and onMaxRadius will be called when reached
	 * @param maxRadius
	 */
